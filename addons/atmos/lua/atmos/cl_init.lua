...
local function AtmosSettings( CPanel )
	...
	CPanel.enabled = CPanel:AddControl( "CheckBox", { Label = "#atmos.enabled", Help = true } );

	-- atmos paused
	language.Add( "atmos.paused", "Paused" );
	language.Add( "atmos.paused.help", "Turn atmos time progression on or off" );

	CPanel.paused = CPanel:AddControl( "CheckBox", { Label = "#atmos.paused", Help = true } );
	...
	CPanel.realtime = CPanel:AddControl( "CheckBox", { Label = "#atmos.realtime", Help = true } );

	-- weather enabled
	language.Add( "atmos.weather", "Weather" );
	language.Add( "atmos.weather.help", "Turn weather on or off" );

	CPanel.weather = CPanel:AddControl( "CheckBox", { Label = "#atmos.weather", Help = true } );

	-- snow enabled
	language.Add( "atmos.snowenabled", "Snow" );
	language.Add( "atmos.snowenabled.help", "Turn snow on or off" );

	CPanel.snowenabled = CPanel:AddControl( "CheckBox", { Label = "#atmos.snowenabled", Help = true } );
	...
	CPanel.length_day = CPanel:AddControl( "Slider", { Label = "#atmos.dnclength_day", Type = "Int", Min = 30, Max = 7200, Help = true } );
	...
	CPanel.length_night = CPanel:AddControl( "Slider", { Label = "#atmos.dnclength_night", Type = "Int", Min = 30, Max = 7200, Help = true } );
	...
	CPanel.weatherchance = CPanel:AddControl( "Slider", { Label = "#atmos.weatherchance", Type = "Int", Min = 0, Max = 100, Help = true } );
	...
	CPanel.weatherlength = CPanel:AddControl( "Slider", { Label = "#atmos.weatherlength", Type = "Int", Min = 0, Max = 3600, Help = true } );
	...
	CPanel.weatherdelay = CPanel:AddControl( "Slider", { Label = "#atmos.weatherdelay", Type = "Int", Min = 60, Max = 3600, Help = true } );
