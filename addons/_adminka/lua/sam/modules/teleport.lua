...
command.new("sit")
	...
	:OnExecute(function(ply)
		...
		ply:SetPos(Vector(-1565.1293945313, -3280.9350585938, 801.38122558594))
		ply:SetEyeAngles(ply:EyePos():Angle())

		sam.player.send_message(nil, "admroom", {
			A = ply
		})
	end)
:End()
