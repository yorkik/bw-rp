...
surface.CreateFont('HudFont', { font = 'Montserrat Bold', size = 19, weight = 350, extended = true })
local function HUDPaint()
    ...
    draw_SimpleText(reason, 'HudFont', scrW-5, scrH/2, color_white, TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP)
end
